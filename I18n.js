...
var ROWS = [
  ...
  ["local.credit", "On this Wi-Fi, by this computer's network name", "En esta Wi-Fi, por el nombre de red de este equipo", "Sur ce Wi-Fi, par le nom réseau de cet ordinateur", "In diesem WLAN, über den Netzwerknamen dieses Computers", "通过这台电脑的网络名称，在此 Wi-Fi 上", "इस Wi-Fi पर, इस कंप्यूटर के नेटवर्क नाम से", "この Wi-Fi で、このパソコンのネットワーク名", "이 Wi-Fi 에서, 이 컴퓨터의 네트워크 이름"],
  ["local.hint", "This computer has no Rust toolchain. The phone opens it by its network name. A terminal asks to allow one port.", "Este equipo no tiene Rust. El teléfono lo abre por su nombre de red. Una terminal pide permitir un puerto.", "Cet ordinateur n'a pas Rust. Le téléphone l'ouvre par son nom réseau. Un terminal demande d'autoriser un port.", "Auf diesem Computer fehlt Rust. Das Telefon öffnet ihn über seinen Netzwerknamen. Ein Terminal bittet, einen Port zu erlauben.", "这台电脑没有 Rust。手机通过它的网络名称打开它。终端会请求允许一个端口。", "इस कंप्यूटर पर Rust नहीं है। फ़ोन इसे उसके नेटवर्क नाम से खोलता है। एक टर्मिनल एक पोर्ट की अनुमति माँगता है।", "このパソコンには Rust がありません。スマホはネットワーク名で開きます。端末がポートの許可を求めます。", "이 컴퓨터에는 Rust 가 없습니다. 휴대전화가 네트워크 이름으로 엽니다. 터미널이 포트 하나를 허용하라고 요청합니다."],
  ["local.use", "Use this network", "Usar esta red", "Utiliser ce réseau", "Dieses Netzwerk verwenden", "使用此网络", "इस नेटवर्क का उपयोग करें", "このネットワークを使う", "이 네트워크 사용"],
  ...
  ["qr.local", "The phone must be on this Wi-Fi. The address is this computer's network name.", "El teléfono debe estar en esta Wi-Fi. La dirección es el nombre de red de este equipo.", "Le téléphone doit être sur ce Wi-Fi. L'adresse est le nom réseau de cet ordinateur.", "Das Telefon muss in diesem WLAN sein. Die Adresse ist der Netzwerkname dieses Computers.", "手机必须在此 Wi-Fi 上。地址是这台电脑的网络名称。", "फ़ोन इस Wi-Fi पर होना चाहिए। पता इस कंप्यूटर का नेटवर्क नाम है।", "スマホはこの Wi-Fi 上にある必要があります。アドレスはこのパソコンのネットワーク名です。", "휴대전화가 이 Wi-Fi 에 있어야 합니다. 주소는 이 컴퓨터의 네트워크 이름입니다."],
